...
// Реэкспорт для существующих вызывающих: владельцы переехали в codeowners.js
// (разрыв цикла repo-intel ↔ architecture, найденного Modularity Analyzer).
export { parseCodeowners, ownersForFiles } from './codeowners.js'
