...
node "$ROOT/plugins/gildra-dsh-runtime/test/new-large-module.test.mjs"
node "$ROOT/plugins/gildra-dsh-runtime/test/responsibility-expansion.test.mjs"
node "$ROOT/plugins/gildra-dsh-runtime/test/public-api-gate.test.mjs"
node "$ROOT/plugins/gildra-dsh-runtime/test/capabilities.test.mjs"
node "$ROOT/plugins/gildra-dsh-runtime/test/authority.test.mjs"
...
node "$ROOT/plugins/gildra-dsh-runtime/test/team-consistency.test.mjs"
